...
import { UserBalanceComponent } from 'app/entities/user-balance/user-balance.component';
  ...
  describe('UserBalance Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserBalanceComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userBalances && comp.userBalances[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
