...
import { UsertransactionsComponent } from 'app/entities/usertransactions/usertransactions.component';
...
describe('Component Tests', () => {
  describe('Usertransactions Management Component', () => {
    let comp: UsertransactionsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UsertransactionsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.usertransactions && comp.usertransactions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
